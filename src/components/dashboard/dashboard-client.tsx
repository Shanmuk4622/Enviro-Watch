...
import { listenToDevices } from "@/lib/devices-client";

interface DashboardClientProps {
  initialDevices: SensorDevice[];
}

export function DashboardClient({ initialDevices }: DashboardClientProps) {
  ...
  useEffect(() => {
    const unsubscribe = listenToDevices((updatedDevices) => {
